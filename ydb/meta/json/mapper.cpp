...
void NMeta::MapJsonValues(NJson::TJsonValue& input, TJsonMergeContext& context) {
...
NActors::TActorId NMeta::CreateJsonMapper(TJsonMergeContextPtr context, const NActors::TActorContext& ctx) {
