...
bool NMeta::ReduceJsonValues(NJson::TJsonValue& output, NJson::TJsonValue& input, TJsonMergeContext& context) {
...
NMeta::TJsonReducer NMeta::ReduceGroupBy(const TVector<TString>& paths) {
...
NMeta::TJsonReducer NMeta::ReduceGroupBy(const TString& path) {
    return ReduceGroupBy(TVector<TString>({path}));
}

NMeta::TJsonReducer NMeta::ReduceWithSum() {
...
NMeta::TJsonReducer NMeta::ReduceWithMax() {
    return [](NJson::TJsonValue& output, NJson::TJsonValue& input, TJsonMergeContext& context) {
        if (output.IsDefined()) {
            switch (input.GetType()) {
            case NJson::JSON_UINTEGER:
...
NMeta::TJsonReducer NMeta::ReduceWithMin() {
    return [](NJson::TJsonValue& output, NJson::TJsonValue& input, TJsonMergeContext& context) {
        if (output.IsDefined()) {
            switch (input.GetType()) {
            case NJson::JSON_UINTEGER:
...
NMeta::TJsonReducer NMeta::ReduceArray() {
    return [](NJson::TJsonValue& output, NJson::TJsonValue& input, TJsonMergeContext& context) {
        return ReduceJsonArray(output, input, context);
    };
}

NMeta::TJsonReducer NMeta::ReduceMap() {
    return [](NJson::TJsonValue& output, NJson::TJsonValue& input, TJsonMergeContext& context) {
        return ReduceJsonMap(output, input, context);
    };
}

NMeta::TJsonReducer NMeta::ReduceChooseAny() {
...
NMeta::TJsonReducer NMeta::ReduceWithArray() {
    return [](NJson::TJsonValue& output, NJson::TJsonValue& input, TJsonMergeContext&) {
...
NMeta::TJsonReducer NMeta::ReduceWithUnique() {
    return [](NJson::TJsonValue& output, NJson::TJsonValue& input, TJsonMergeContext&) {
...
NMeta::TJsonReducer NMeta::ReduceWithUniqueArray() {
    return [](NJson::TJsonValue& output, NJson::TJsonValue& input, TJsonMergeContext&) {
        JoinJsonValuesToArray(output, std::move(input));
...
NMeta::TJsonReducer NMeta::ReduceWithUniqueValue() {
    return [](NJson::TJsonValue& output, NJson::TJsonValue& input, TJsonMergeContext& context) {
        if (!output.IsDefined()) {
            output = std::move(input);
        } else {
...
NActors::TActorId NMeta::CreateJsonReducer(TJsonMergeContextPtr context, const NActors::TActorId& owner, const NActors::TActorContext& ctx) {
